...
def resnet_main(
    ...
    #####
    ##### Add profiling to the training hooks
    #####

    # # TODO: Don't hardcode output path
    # _profiler = tf.train.ProfilerHook(
    #     output_dir = "/log",
    #     save_steps = 1,
    #     show_memory = True,
    # )
    # train_hooks.append(_profiler)
    ...
    for cycle_index, num_train_epochs in enumerate(schedule):
        ...
        if num_train_epochs:
            classifier.train(input_fn=lambda: input_fn_train(num_train_epochs), hooks=train_hooks, max_steps=flags_obj.max_train_steps)
